...
def load_feature_and_label(feature_dir, scale_idx,bc):
    ...
    """
    file_path = os.path.join(feature_dir, f"CLIP_{bc}_feature_gen5_scale{scale_idx}.hdf5")   ##生成集多尺度目录
...
save_feature_path = f"D:\\PYproject\\clipI\\dataset\\{dataset_name}\\CLIP_{model_name}_feature_gen5_multi_scale.hdf5"   ##生成集最终特征保存路径
# Combine features
