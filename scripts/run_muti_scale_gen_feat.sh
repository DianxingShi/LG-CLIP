...
# --------------------------
# Extract multi-scale CLIP features from generated images (10 scales).
# Produces per-scale HDF5 cache files + one merged multi-scale file.
#
# Prerequisite:
#   Generated images must exist (from sd_gen.py / llm_sd_gen.py with Ngen=10).
#
# Usage:
#   bash scripts/run_muti_scale_gen_feat.sh [OPTIONS]
#
# Options (all optional, defaults shown):
#   --dataset       Dataset name  (default: PET)
#   --Ngen          Images per class  (default: 10)
#   --LLM           "LLM_" for LLM-guided, "" for plain SD  (default: "")
#   --backbone      CLIP backbone  (default: ViT-L/14)
#   --image_root    Dataset root  (default: ./dataset)
#   --gen_root_path Generated image root  (auto-set from LLM flag if not given)
...
#   bash scripts/run_muti_scale_gen_feat.sh --dataset EUROSAT --backbone RN50
# =============================================================================
...
echo "========================================================"
echo " Running: muti_scale_gen_feat.py (multi-scale gen features)"
